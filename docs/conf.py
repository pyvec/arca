...
htmlhelp_basename = 'Arcadoc'


intersphinx_mapping = {'dogpile': ('https://dogpilecache.readthedocs.io/en/latest/', None),
                       'gitpython': ('https://gitpython.readthedocs.io/en/stable/', None),
                       'python': ('https://docs.python.org/3/', None),
                       'entrypoints': ('http://entrypoints.readthedocs.io/en/latest/', None),
